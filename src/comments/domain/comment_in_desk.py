...
from src.comments.domain.attachments_desk import AttachmentsDesk


class CommentInDesk:

    def __init__(self, ticket_id, text=None, author_id=None, public=True, is_agent=True, attachments=None,
                 text_json=None):
    ...
    def is_agent(self, is_agent):
        if not isinstance(is_agent, bool):
            raise TypeErrorValue('is_agent')

        self.__is_agent = is_agent
    ...
    def attachments(self, attachments):
        self.__attachments = AttachmentsDesk(attachments)
