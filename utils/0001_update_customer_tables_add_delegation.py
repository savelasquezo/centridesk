...
if __name__ == '__main__':
    ...
    if args.apply:
        print('Apply Changes')
        query1 = "alter table $DBNAME.customers add column `delegation` longtext DEFAULT NULL after company;"
    elif args.rollback:
        print('Rollback')
        query1 = "alter table $DBNAME.customers drop column `delegation`"
    else:
        exit(0)
